  ...
  return (
    <>
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 pointer-events-none">
        <div
          className="bg-card border border-border rounded-lg shadow-xl w-full max-w-md pointer-events-auto"
          style={{
        ...
        >
          ...
          <div className="flex items-center justify-between px-6 py-4 border-b border-border">
            ...
            <button
              onClick={onClose}
              className="p-1 rounded bg-transparent border-none cursor-pointer text-muted-foreground transition-colors duration-100 hover:text-foreground hover:bg-secondary"
            >
              <X size={18} />
            </button>
          </div>
          ...
          <form onSubmit={handleSubmit} className="px-6 py-5">
            ...
            <div className="mb-4">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  autoFocus
                  disabled={sending}
                  className="w-full pl-10 pr-4 py-2.5 text-sm font-sans bg-background border border-border rounded-md text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-primary disabled:opacity-50 disabled:cursor-not-allowed"
                />
              </div>
            </div>
            ...
            {/* Error message */}
            {error && (
              <div className="mb-4 px-3 py-2 rounded-md bg-destructive/10 border border-destructive/20">
            ...
            {success && (
              <div className="mb-4 px-3 py-2 rounded-md bg-primary/10 border border-primary/20">
                <p className="text-sm text-primary font-sans">Invitation sent!</p>
              </div>
            )}
            ...
            <div className="flex gap-2">
              <button
                ...
                onClick={onClose}
                disabled={sending}
                className="flex-1 px-4 py-2.5 text-sm font-sans font-medium rounded-md border border-border bg-transparent text-foreground transition-colors duration-100 hover:bg-secondary disabled:opacity-50 disabled:cursor-not-allowed"
              >
                Cancel
              </button>
              <button
